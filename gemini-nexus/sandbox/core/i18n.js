...
export const translations = {
    en: {
        ...
        "openaiWebSearchDesc": "Uses the selected API interface: Responses web_search or Chat Completions web_search_options. Not every compatible endpoint supports this.",
        "modelIds": "Model IDs",
    ...
    zh: {
        ...
        "openaiWebSearchDesc": "按当前接口发送联网参数：Responses web_search 或 Chat Completions web_search_options。并非所有兼容接口都支持。",
        "modelIds": "模型 IDs",
